...
const TopVillas = () => {
  return (
    <section id="topVillas">
      <h1>Our Tops Villas</h1>
      <p>
        Discover top villas featuring elegant design, beautiful locations, world-class facilities, and complete privacy for a perfect vacation escape.
      </p>
